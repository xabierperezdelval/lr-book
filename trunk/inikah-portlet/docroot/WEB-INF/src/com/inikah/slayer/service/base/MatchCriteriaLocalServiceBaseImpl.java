...
import com.inikah.slayer.service.MatchCriteriaLocalService;
...
/**
 * Provides the base implementation for the match criteria local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.inikah.slayer.service.impl.MatchCriteriaLocalServiceImpl}.
 * </p>
 *
 * @author Ahmed Hasan
 * @see com.inikah.slayer.service.impl.MatchCriteriaLocalServiceImpl
 * @see com.inikah.slayer.service.MatchCriteriaLocalServiceUtil
 * @generated
 */
public abstract class MatchCriteriaLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MatchCriteriaLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.inikah.slayer.service.MatchCriteriaLocalServiceUtil} to access the match criteria local service.
	 */

	/**
	 * Adds the match criteria to the database. Also notifies the appropriate model listeners.
	 *
	 * @param matchCriteria the match criteria
	 * @return the match criteria that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MatchCriteria addMatchCriteria(MatchCriteria matchCriteria)
		throws SystemException {
		matchCriteria.setNew(true);

		return matchCriteriaPersistence.update(matchCriteria);
	}
	 ...
	 */
	@Override
	public MatchCriteria createMatchCriteria(long profileId) {
		return matchCriteriaPersistence.create(profileId);
	}

	/**
	 * Deletes the match criteria with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param profileId the primary key of the match criteria
	 * @return the match criteria that was removed
	 * @throws PortalException if a match criteria with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MatchCriteria deleteMatchCriteria(long profileId)
		throws PortalException, SystemException {
		return matchCriteriaPersistence.remove(profileId);
	}

	/**
	 * Deletes the match criteria from the database. Also notifies the appropriate model listeners.
	 *
	 * @param matchCriteria the match criteria
	 * @return the match criteria that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MatchCriteria deleteMatchCriteria(MatchCriteria matchCriteria)
		throws SystemException {
		return matchCriteriaPersistence.remove(matchCriteria);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MatchCriteria.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return matchCriteriaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return matchCriteriaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MatchCriteria fetchMatchCriteria(long profileId)
		throws SystemException {
		return matchCriteriaPersistence.fetchByPrimaryKey(profileId);
	}

	/**
	 * Returns the match criteria with the primary key.
	 *
	 * @param profileId the primary key of the match criteria
	 ...
	 */
	@Override
	public MatchCriteria getMatchCriteria(long profileId)
		throws PortalException, SystemException {
		return matchCriteriaPersistence.findByPrimaryKey(profileId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return matchCriteriaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MatchCriteria> getMatchCriterias(int start, int end)
		throws SystemException {
		return matchCriteriaPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMatchCriteriasCount() throws SystemException {
		return matchCriteriaPersistence.countAll();
	}

	/**
	 * Updates the match criteria in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param matchCriteria the match criteria
	 * @return the match criteria that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MatchCriteria updateMatchCriteria(MatchCriteria matchCriteria)
		throws SystemException {
		return matchCriteriaPersistence.update(matchCriteria);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.inikah.slayer.model.MatchCriteria",
			matchCriteriaLocalService);
	}
	...
	protected String getModelClassName() {
		return MatchCriteria.class.getName();
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = matchCriteriaPersistence.getDataSource();
	...
	private MatchCriteriaLocalServiceClpInvoker _clpInvoker = new MatchCriteriaLocalServiceClpInvoker();
}