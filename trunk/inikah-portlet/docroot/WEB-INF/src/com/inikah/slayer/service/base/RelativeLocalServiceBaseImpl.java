...
import com.inikah.slayer.service.RelativeLocalService;
...
/**
 * Provides the base implementation for the relative local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.inikah.slayer.service.impl.RelativeLocalServiceImpl}.
 * </p>
 *
 * @author Ahmed Hasan
 * @see com.inikah.slayer.service.impl.RelativeLocalServiceImpl
 * @see com.inikah.slayer.service.RelativeLocalServiceUtil
 * @generated
 */
public abstract class RelativeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements RelativeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.inikah.slayer.service.RelativeLocalServiceUtil} to access the relative local service.
	 */

	/**
	 * Adds the relative to the database. Also notifies the appropriate model listeners.
	 *
	 * @param relative the relative
	 * @return the relative that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Relative addRelative(Relative relative) throws SystemException {
		relative.setNew(true);

		return relativePersistence.update(relative);
	}
	 ...
	 */
	@Override
	public Relative createRelative(long relativeId) {
		return relativePersistence.create(relativeId);
	}

	/**
	 * Deletes the relative with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param relativeId the primary key of the relative
	 * @return the relative that was removed
	 * @throws PortalException if a relative with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Relative deleteRelative(long relativeId)
		throws PortalException, SystemException {
		return relativePersistence.remove(relativeId);
	}

	/**
	 * Deletes the relative from the database. Also notifies the appropriate model listeners.
	 *
	 * @param relative the relative
	 * @return the relative that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Relative deleteRelative(Relative relative) throws SystemException {
		return relativePersistence.remove(relative);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Relative.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return relativePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return relativePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return relativePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return relativePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Relative fetchRelative(long relativeId) throws SystemException {
		return relativePersistence.fetchByPrimaryKey(relativeId);
	}

	/**
	 * Returns the relative with the primary key.
	 *
	 * @param relativeId the primary key of the relative
	 * @return the relative
	 * @throws PortalException if a relative with the primary key could not be found
	 ...
	 */
	@Override
	public Relative getRelative(long relativeId)
		throws PortalException, SystemException {
		return relativePersistence.findByPrimaryKey(relativeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return relativePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Relative> getRelatives(int start, int end)
		throws SystemException {
		return relativePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRelativesCount() throws SystemException {
		return relativePersistence.countAll();
	}

	/**
	 * Updates the relative in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param relative the relative
	 * @return the relative that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Relative updateRelative(Relative relative) throws SystemException {
		return relativePersistence.update(relative);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.inikah.slayer.model.Relative",
			relativeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = relativePersistence.getDataSource();
	...
	private RelativeLocalServiceClpInvoker _clpInvoker = new RelativeLocalServiceClpInvoker();
}