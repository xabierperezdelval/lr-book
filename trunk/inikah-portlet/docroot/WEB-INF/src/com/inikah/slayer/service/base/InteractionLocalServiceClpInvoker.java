...
public class InteractionLocalServiceClpInvoker {
	public InteractionLocalServiceClpInvoker() {
		...
		_methodParameterTypes0 = new String[] {
				"com.inikah.slayer.model.Interaction"
			};
		...
		_methodName10 = "fetchInteraction";

		_methodParameterTypes10 = new String[] { "long" };

		_methodName11 = "getInteraction";
		...
		_methodName13 = "getInteractions";

		_methodParameterTypes13 = new String[] { "int", "int" };

		_methodName14 = "getInteractionsCount";
		...
		_methodName108 = "setOperation";

		_methodParameterTypes108 = new String[] { "long", "long", "int", "long" };

		_methodName109 = "getInteractionsInitiatedByMe";

		_methodParameterTypes109 = new String[] { "long", "long" };

		_methodName110 = "getInteractionsInitiatedByOthers";

		_methodParameterTypes110 = new String[] { "long", "long" };

		_methodName111 = "getInteractionsInitiatedByMe";

		_methodParameterTypes111 = new String[] { "long" };

		_methodName112 = "getInteractionsInitiatedByOthers";

		_methodParameterTypes112 = new String[] { "long" };

		_methodName113 = "getInteractionsInitiatedByMe";

		_methodParameterTypes113 = new String[] { "long", "int" };

		_methodName114 = "getInteractionsInitiatedByOthers";

		_methodParameterTypes114 = new String[] { "long", "int" };

		_methodName115 = "getTargetIds";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return InteractionLocalServiceUtil.addInteraction((com.inikah.slayer.model.Interaction)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return InteractionLocalServiceUtil.deleteInteraction((com.inikah.slayer.model.Interaction)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return InteractionLocalServiceUtil.updateInteraction((com.inikah.slayer.model.Interaction)arguments[0]);
		}
		...
		if (_methodName108.equals(name) &&
			...
			return InteractionLocalServiceUtil.setOperation(((Long)arguments[0]).longValue(),
		...
		if (_methodName109.equals(name) &&
			...
			return InteractionLocalServiceUtil.getInteractionsInitiatedByMe(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}

		if (_methodName110.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes110, parameterTypes)) {
			return InteractionLocalServiceUtil.getInteractionsInitiatedByOthers(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}
		...
		if (_methodName115.equals(name) &&
			...
			return InteractionLocalServiceUtil.getTargetIds(((Long)arguments[0]).longValue(),
				((Integer)arguments[1]).intValue());
		}
