...
public class InteractionServiceClpInvoker {
	public InteractionServiceClpInvoker() {
		...
		_methodName92 = "setViewed";

		_methodParameterTypes92 = new String[] { "long", "long" };

		_methodName93 = "setBlocked";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName92.equals(name) &&
			...
			InteractionServiceUtil.setViewed(((Long)arguments[0]).longValue(),
		...
		if (_methodName93.equals(name) &&
			...
			InteractionServiceUtil.setBlocked(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
