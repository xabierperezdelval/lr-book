...
import com.inikah.slayer.service.EarningLocalService;
...
/**
 * Provides the base implementation for the earning local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.inikah.slayer.service.impl.EarningLocalServiceImpl}.
 * </p>
 *
 * @author Ahmed Hasan
 * @see com.inikah.slayer.service.impl.EarningLocalServiceImpl
 * @see com.inikah.slayer.service.EarningLocalServiceUtil
 * @generated
 */
public abstract class EarningLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements EarningLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.inikah.slayer.service.EarningLocalServiceUtil} to access the earning local service.
	 */

	/**
	 * Adds the earning to the database. Also notifies the appropriate model listeners.
	 *
	 * @param earning the earning
	 * @return the earning that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Earning addEarning(Earning earning) throws SystemException {
		earning.setNew(true);

		return earningPersistence.update(earning);
	}
	 ...
	 */
	@Override
	public Earning createEarning(long earningId) {
		return earningPersistence.create(earningId);
	}

	/**
	 * Deletes the earning with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param earningId the primary key of the earning
	 * @return the earning that was removed
	 * @throws PortalException if a earning with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Earning deleteEarning(long earningId)
		throws PortalException, SystemException {
		return earningPersistence.remove(earningId);
	}

	/**
	 * Deletes the earning from the database. Also notifies the appropriate model listeners.
	 *
	 * @param earning the earning
	 * @return the earning that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Earning deleteEarning(Earning earning) throws SystemException {
		return earningPersistence.remove(earning);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Earning.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return earningPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return earningPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return earningPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return earningPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return earningPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Earning fetchEarning(long earningId) throws SystemException {
		return earningPersistence.fetchByPrimaryKey(earningId);
	}

	/**
	 * Returns the earning with the primary key.
	 *
	 * @param earningId the primary key of the earning
	 * @return the earning
	 * @throws PortalException if a earning with the primary key could not be found
	...
	public Earning getEarning(long earningId)
		throws PortalException, SystemException {
		return earningPersistence.findByPrimaryKey(earningId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return earningPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Earning> getEarnings(int start, int end)
		throws SystemException {
		return earningPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEarningsCount() throws SystemException {
		return earningPersistence.countAll();
	}

	/**
	 * Updates the earning in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param earning the earning
	 * @return the earning that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Earning updateEarning(Earning earning) throws SystemException {
		return earningPersistence.update(earning);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.inikah.slayer.model.Earning",
			earningLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.inikah.slayer.model.Earning");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = earningPersistence.getDataSource();
	...
	private EarningLocalServiceClpInvoker _clpInvoker = new EarningLocalServiceClpInvoker();
}